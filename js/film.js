...
(function () {
  ...
  const CONFIG = window.__DF_CONFIG = {
    ...
    FLIP_T: 6.0,          // the cut: outside becomes inside → chrome near-black → white, OPEN pill outline → red-filled
  ...
  // the still is NOT torn down any more: the film ends by fading back to it (the front of the building)
